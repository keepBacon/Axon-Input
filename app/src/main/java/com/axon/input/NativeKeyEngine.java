...
/** 键盘和鼠标按键状态的 JNI 入口。Java 只传递语义状态，位运算由 C++ 处理。 */
public final class NativeKeyEngine {
    ...
    /**
     * Updates one mouse button. button=0 left, button=1 right.
     * eventTimeMs is monotonic uptime in milliseconds.
     */
    public static native long nativeUpdateMouseButton(int button, boolean pressed, long eventTimeMs);

    /** Returns packed mouse state: bits 0-1 pressed, bits 8-15 left DPS, bits 16-23 right DPS. */
